...
from constants.paths import PATH_OSU_SESSION, PATH_OSU_BEATMAPS_DOWNLOADS
...
def download_beatmap(session: requests.Session, beatmapset_url:str, file_name:str) -> str:
    ...
    warn(f"Download from bancho failed, using mirror {download_url}")
    return download_url
